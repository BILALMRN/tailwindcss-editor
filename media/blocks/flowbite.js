export const blocksFlowbite = [
  {
    id: "Hero-Sections-1",
    label: "Hero-Sections : Default hero section",
    content: `
<section class="bg-white dark:bg-gray-900">
  ...
  {
    id: "Hero-Sections-2",
    label: "Hero-Sections : Visual image with heading",
    content: `
<section class="bg-white dark:bg-gray-900">
...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
  ...
  {
    id: "Table-Headers-2",
    label: "Table header : text and button",
    content: `
<section class="flex items-center h-screen bg-gray-50 dark:bg-gray-900">
  ...
  },
  {
    ...
    label: "Application shell : sidebar and navbar",
    content: `
